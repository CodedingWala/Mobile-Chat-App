            ...
            <View className="flex-1 justify-center px-6 py-10">
              ...
              <View className="gap-5">
                <View>
                  ...
                  <View
                    className={`flex-row items-center bg-white rounded-xl border ${errors.name ? "border-red-400" : "border-gray-200"
                      } shadow-sm`}
                  >
                    <View className="pl-4">
                  ...
                  {errors.name && (
                    <Text className="text-red-500 text-xs mt-1.5 ml-1">{errors.name}</Text>
                  )}
                </View>
