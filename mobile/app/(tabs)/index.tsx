...
const ChatsTab = () => {
  ...
  const { data: chats, isPending, isLoading, error, refetch,isFetching,status } = UseChats();
  console.log("🟡 STATE:", { isLoading, isPending, isFetching, status, chats, error });
  ...
  return (
    <View className="flex-1 bg-surface">
      <FlatList
        ...
        renderItem={({ item }) => <ChatItem chat={item} onPress={() =>
